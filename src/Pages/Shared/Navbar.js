...
const Navbar = () => {
    ...
    return (
        <div className="fixed top-0 z-50 left-0 bg-green-100 w-full">
            ...
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost normal-case text-xl">
                    {/* <img src={logo} alt="" /> */}
                    {/* <h1 class="text-xl md:text-xl text-primary font-bold"  data-aos="zoom-in-right" data-aos-delay="300" data-aos-duration="800" ><span className='text-accent'>Car Service </span>Tools</h1> */}

                    <Link to='/'> <h1 class="text-xl md:text-xl text-primary font-bold"  data-aos="zoom-in-right" data-aos-delay="300" data-aos-duration="800" ><span className='text-accent'>Car Service </span>Tools</h1> </Link>
