...
const Banner = () => {
    return (
        <div class="hero mt-16 lg:py-16 bg-slate-100 lg:w-full">
            <div class="hero-content mx-4 md:mx-8 lg:mx-16 flex-col lg:flex-row-reverse">
                <div className="">
                 <img src={banner} class=" md:max-w-md " />
                </div>
                <div className=''>
                <h1 class="md:text-xl text-cyan-500 font-bold"  data-aos="zoom-in-right" data-aos-delay="100" data-aos-duration="800">World Best Quality</h1>
                <h1 class="text-3xl md:text-5xl text-primary font-bold"  data-aos="zoom-in-right" data-aos-delay="300" data-aos-duration="800"><span className='text-accent'>New Car </span>Parts</h1>
