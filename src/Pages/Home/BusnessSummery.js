...
const BusnessSummery = () => {
    ...
    return (
        <div className='my-10'>
            <h1 className='text-center text-secondary uppercase font-bold text-xl md:text-4xl my-5' data-aos="zoom-in-down" data-aos-delay="100" data-aos-duration="800">millions business trust us</h1>
            <h1 className='text-center text-primary uppercase md:text-xl my-5' data-aos="zoom-in-up" data-aos-delay="300" data-aos-duration="800">try to understands user expectation</h1>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {
                    summery.map(items => <div className="text-center border hover:border-blue-900 transition rounded-xl mt-5 p-3" data-aos="zoom-in-right" data-aos-delay="100" data-aos-duration="800">
                        ...
                        <div className="">
                            ...
                            <h1 className='text-xl text-black-500 font-bold'>{items.name}</h1>
                        </div>
                    </div>)
                }
            </div>
            <div className="sm:flex my-5 border shadow-lg rounded-xl items-center p-8">
                ...
                <h1 className='text-xl md:text-3xl text-black-500 font-bold'>Have any query? Let's get in touch.</h1>
                <h1 className='md:text-xl text-primary'>feel free to contact us.</h1>
                </div>
